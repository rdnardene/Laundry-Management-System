		...
		<div class="col-lg-12">	
			...
			<div class="row">
				<div class="col-md-6">	
					<div class="form-group">	
						...
						<input type="phone" class="form-control" name="phone" value="+63 <?php echo isset($phone) ? $phone : '' ?>">
					</div>
				</div>
			...
			<div class="row">
				<div class="form-group col-md-6">
					...
					<textarea name="remarks" id="" cols="30" rows="2" class="form-control" placeholder="Optional"><?php echo isset($remarks) ? $remarks : '' ?></textarea>
				</div>
			</div>
			<hr>	
			<div class="row">	
