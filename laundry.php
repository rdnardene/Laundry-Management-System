					...
					<div class="row">
						<div class="col-md-12">		
							<table class="table table-bordered" id="laundry-list">
								...
								<tbody>
									<?php 
									$list = $conn->query("SELECT * FROM laundry_list ");
									...
									<tr>
										...
										<td class=""><span id="phone<?php echo $row['id']; ?>"><?php echo $row['phone']; ?></span></td>
										<?php if($row['status'] == 0): ?>
										...
										<td class="text-center">
											...
											<button type="button" class="btn btn-success modalmessage" value="<?php echo $row['id']; ?>" data-toggle="modal">
											Send Message</button>
										</td>
									</tr>
									<?php endwhile; ?>
 ...
 <script type="text/javascript">
  ...
  $(document).ready(function(){
   ...
   $(document).on('click', '.modalmessage', function(){
    ...
    var contact= $('#phone'+id).text();// get firstname

   
    $('#modalmessage').modal('show');//load modal
